        ...
        <div className="relative bg-white overflow-hidden">
                ...
                <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                  <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                    ...
                    <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                      ...
                      <Link to={'/form'} className="font-medium text-gray-500 hover:text-gray-900">Form</Link>
          ...
          */}
                <div className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                  <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1">
                      ...
                      <Link to={'/form'} className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Form</Link>
                    </div> 
                    ...
                    <Link to={'/register'} className="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-100"> Register </Link>
                  </div>
                </div>
              </div>
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    <span className="block xl:inline">Pendataan Bantuan Sosial {`\n`}</span>
                    <span className="block text-indigo-600 xl:inline">Komplek Panghegar</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Fulfill and submit Society Data easily with SocietyPanghegar Website. A smooth, Beautiful Interface and Quick Performance make RT/RW jobs more efficient. </p>
          ...
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img className="h-56 w-full bg-center object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={societyImg} alt="Society Image" />
          </div>
        </div>
        </>
      );
